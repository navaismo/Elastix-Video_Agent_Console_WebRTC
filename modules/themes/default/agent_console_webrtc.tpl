...
<link href="modules/video_agent_console_webrtc/themes/default/css/bootstrap.css" rel="stylesheet" />
<link href="modules/video_agent_console_webrtc/themes/default/css/textarea.css" rel="stylesheet" />
<script src="modules/video_agent_console_webrtc/themes/default/js/SIPml-api.js"></script>
<script src="modules/video_agent_console_webrtc/themes/default/js/ml5.js"></script>
{* --mein Fin SipML5 *}
...
type="button" style="width: 33%" class="btn-primary" value="#" onclick="sipSendDTMF('#');"/></td></tr>
	...
	<div align="center">
        ...
        <audio id="ringtone" loop src="modules/video_agent_console_webrtc/themes/default/sounds/ringtone.wav" />
        <audio id="ringbacktone" loop src="modules/video_agent_console_webrtc/themes/default/sounds/ringbacktone.wav" />
        <audio id="dtmfTone" src="modules/video_agent_console_webrtc/themes/default/sounds/dtmf.wav" />
        <audio id="newmsg" src="modules/video_agent_console_webrtc/themes/default/sounds/newmsg.wav" />
					...
					<table>
						<tr>
							<td>
								...
								<input type="text" name="sendchat" class="styletext"id="sendchat" onkeypress="handleKeyPress(event)" />
						                <input type="button" class="btn-success" style="" id="btnIM" value="Send" onclick='sendIM();' />&nbsp;	
							</td>

							<td width="100%" height="100%">
								<div id="divVideo" class='hiddden1'>
					                                <div align="center" id="divVideoRemote" style='border:0px solid #000; height:100%; width:100%'>                                    
										<video class="video" width="110%" height="110%" id="video_remote" autoplay="autoplay" style="opacity: 1; background-color: #000000; -webkit-transition-property: opacity; -webkit-transition-duration: 2s;">
					                                    	</video>
                                					</div>
					
					                                <div id="divVideoLocal" style='border:0px solid #000'>
						                                <video  class="video" width="140px" height="110px" id="video_local" autoplay="autoplay" muted="true" style="opacity: 1; margin-top: -80px; margin-left: 90px; background-color: #000000; -webkit-transition-property: opacity; -webkit-transition-duration: 2s;">
						                                </video>
									</div>
								</div>
