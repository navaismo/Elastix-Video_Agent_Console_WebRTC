...
{else}
<form method="POST"  action="index.php?menu=video_agent_console_webrtc" onsubmit="do_login(); return false;">
...
<div align=center>
        <form  action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
                ...
                <input type="hidden" name="hosted_button_id" value="TJFYQ9P438K5E" />
                <input type="image" src="https://www.paypalobjects.com/es_XC/MX/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal, la forma más segura y rápida de pagar en línea." />
                <img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1" />
        </form>
        <p style="font-size: 11px; color: gray; font-style: italic;">Your donation keeps this addon free and support us to improve it ;)</p>
</div>
