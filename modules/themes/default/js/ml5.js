...
***********************/
	...
	var myrealm = $("#ml5realm").val();
	var myusn = $("#ml5usn").val();
	var mysipuri = $("#ml5sipuri").val();
	var mycid = $("#ml5cid").val();
		...
		switch(e.type){
			...
			// future use with video
		         case 'm_stream_video_local_added': {
		                    if (e.session == mycallSession) {
					console.log("see my video uhuhuhuhu");
					$("#divVideoLocal").show();
					$("#divVideo").show();
                    		    }
                    		break;
			...
			//future use with video
	               case 'm_stream_video_local_removed': {
		                    if (e.session == mycallSession) {
					console.log("closing my video uhuhuhuhu");
					$("#divVideoLocal").hide();
                    		    }
                    		break;
                	}
			...
			//future use with video
		       case 'm_stream_video_remote_added':  {
		                    if (e.session == mycallSession) {
					console.log("see your video uhuhuhuhu");
					$("#divVideoRemote").show();
                    		    }
	                        break;
            		}
			...
			//future use with video
		        case 'm_stream_video_remote_removed': {
		                    if (e.session == mycallSession) {
					console.log("closing your video uhuhuhuhu");
					$("#divVideoRemote").hide();
                    		    }
                    		break;
                	}
 ...
 function call(){
	...
	if (flag=='0' && mySipStack && $("#callnumber").val() != ''){
	       //create the session to call
                        mycallSession = mySipStack.newSession('call-video', {
                                audio_remote: document.getElementById('audio_remote'),
                                audio_local: document.getElementById('audio_local'),
                                video_remote: document.getElementById('video_remote'),
                                video_local: document.getElementById('video_local'),
